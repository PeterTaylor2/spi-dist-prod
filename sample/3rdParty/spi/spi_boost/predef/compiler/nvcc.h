...
#ifndef SPI_BOOST_PREDEF_COMPILER_NVCC_H
#define SPI_BOOST_PREDEF_COMPILER_NVCC_H

#include <spi_boost/predef/version_number.h>
#include <spi_boost/predef/make.h>

/*`
[heading `SPI_BOOST_COMP_NVCC`]
...
#define SPI_BOOST_COMP_NVCC SPI_BOOST_VERSION_NUMBER_NOT_AVAILABLE

#if defined(__NVCC__)
#   if !defined(__CUDACC_VER_MAJOR__) || !defined(__CUDACC_VER_MINOR__) || !defined(__CUDACC_VER_BUILD__)
#       define SPI_BOOST_COMP_NVCC_DETECTION SPI_BOOST_VERSION_NUMBER_AVAILABLE
#   else
#       define SPI_BOOST_COMP_NVCC_DETECTION SPI_BOOST_VERSION_NUMBER(__CUDACC_VER_MAJOR__, __CUDACC_VER_MINOR__, __CUDACC_VER_BUILD__)
#   endif
#endif

#ifdef SPI_BOOST_COMP_NVCC_DETECTION
/*
Always define SPI_BOOST_COMP_NVCC instead of SPI_BOOST_COMP_NVCC_EMULATED
...
allowed to set SPI_BOOST_COMP_NVCC additionally to the already detected host
...
This behavior is similar to what spi_boost config is doing in `select_compiler_config.hpp`.
...
*/
#   undef SPI_BOOST_COMP_NVCC
#   define SPI_BOOST_COMP_NVCC SPI_BOOST_COMP_NVCC_DETECTION
#   define SPI_BOOST_COMP_NVCC_AVAILABLE
#   include <spi_boost/predef/detail/comp_detected.h>
#endif

#define SPI_BOOST_COMP_NVCC_NAME "NVCC"

#endif

#include <spi_boost/predef/detail/test.h>
SPI_BOOST_PREDEF_DECLARE_TEST(SPI_BOOST_COMP_NVCC,SPI_BOOST_COMP_NVCC_NAME)
