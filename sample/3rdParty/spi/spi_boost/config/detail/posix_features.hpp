...
#  if defined(SPI_BOOST_HAS_UNISTD_H)
#     include <unistd.h>
...
#     if defined(_POSIX_THREADS) && (_POSIX_THREADS+0 >= 0) && !defined(SPI_BOOST_HAS_WINTHREADS) && !defined(SPI_BOOST_HAS_MPTASKS)
#        define SPI_BOOST_HAS_PTHREADS
#     endif

      // SPI_BOOST_HAS_NANOSLEEP:
...
#     endif
      ...
      // SPI_BOOST_HAS_GETTIMEOFDAY:
      // SPI_BOOST_HAS_PTHREAD_MUTEXATTR_SETTYPE:
