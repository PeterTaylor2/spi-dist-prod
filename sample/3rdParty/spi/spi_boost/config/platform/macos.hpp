...
#define SPI_BOOST_PLATFORM "Mac OS"
...
#  if !defined(SPI_BOOST_HAS_PTHREADS)
// MPTasks support is deprecated/removed from Boost:
//#    define SPI_BOOST_HAS_MPTASKS
...
#ifdef SPI_BOOST_HAS_PTHREADS
#  define SPI_BOOST_HAS_THREADS
#endif

// The remote call manager depends on this.
#    define SPI_BOOST_BIND_ENABLE_PASCAL
