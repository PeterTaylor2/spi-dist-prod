...
//  absolutely unable to use spi_boost. Old STLs and compilers 
...
//     define=SPI_BOOST_LOG_WITHOUT_IPC
//  and 
//     -DSPI_BOOST_LOG_WITHOUT_DEFAULT_FACTORIES
//  to your compile options.
//
//  When building the test library add 
//     -DSPI_BOOST_TEST_LIMITED_SIGNAL_DETAILS
//  to your compile options
//
...
//  
// In VxWorks 6.x so as to integrate with spi_boost. 
// - Edit the file 
...
//   with the changed properties. That's it! Now, using spi_boost should
...
#  error "The vxWorks version you're using is so badly outdated,\
          it doesn't work at all with spi_boost, sorry, no chance!"
#endif

// Handle versions above 5.X but below 6.9
#if (_WRS_VXWORKS_MAJOR == 6) && (_WRS_VXWORKS_MINOR < 9)
// TODO: Starting from what version does vxWorks work with spi_boost?
// We can't reasonably insert a #warning "" as a user hint here,
// as this will show up with every file including some spi_boost header,
// badly bugging the user... So for the time being we just leave it.
#endif

// vxWorks specific config options:
// --------------------------------
#define SPI_BOOST_PLATFORM "vxWorks"
...
#define SPI_BOOST_LOCALE_WITH_ICU
...
#  define SPI_BOOST_NO_CXX11_ADDRESSOF      // C11 addressof operator on memory location
#  define SPI_BOOST_NO_CXX11_ALLOCATOR
#  define SPI_BOOST_NO_CXX11_ATOMIC_SMART_PTR
#  define SPI_BOOST_NO_CXX11_NUMERIC_LIMITS  // max_digits10 in test/../print_helper.hpp
...
#  define SPI_BOOST_NO_CXX11_HDR_FORWARD_LIST  //serialization/test/test_list.cpp
#  define SPI_BOOST_NO_CXX11_HDR_FUNCTIONAL 
#  define SPI_BOOST_NO_CXX11_HDR_FUTURE
#  define SPI_BOOST_NO_CXX11_HDR_MUTEX
#  define SPI_BOOST_NO_CXX11_HDR_RANDOM      //math/../test_data.hpp
...
#else
#ifndef  SPI_BOOST_SYSTEM_NO_DEPRECATED
#  define SPI_BOOST_SYSTEM_NO_DEPRECATED  // workaround link error in spirit
#endif
#endif
...
#  ifndef SPI_BOOST_ASIO_HAS_POSIX_STREAM_DESCRIPTOR
#    define SPI_BOOST_ASIO_HAS_POSIX_STREAM_DESCRIPTOR
#  endif
#else 
