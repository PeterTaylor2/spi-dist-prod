...
#ifdef __FreeBSD__
#define SPI_BOOST_PLATFORM "FreeBSD " SPI_BOOST_STRINGIZE(__FreeBSD__)
#elif defined(__NetBSD__)
#define SPI_BOOST_PLATFORM "NetBSD " SPI_BOOST_STRINGIZE(__NetBSD__)
#elif defined(__OpenBSD__)
#define SPI_BOOST_PLATFORM "OpenBSD " SPI_BOOST_STRINGIZE(__OpenBSD__)
#elif defined(__DragonFly__)
#define SPI_BOOST_PLATFORM "DragonFly " SPI_BOOST_STRINGIZE(__DragonFly__)
#endif
...
#  define SPI_BOOST_NO_CTYPE_FUNCTIONS
#endif
