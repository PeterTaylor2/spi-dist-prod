...
#  endif
#  if !(defined(_HAS_MEMBER_TEMPLATES_REBIND) && (_HAS_MEMBER_TEMPLATES_REBIND+0 > 0)) && !(defined(_MSC_VER) && (_MSC_VER > 1300)) && defined(SPI_BOOST_MSVC)
#     define SPI_BOOST_NO_STD_ALLOCATOR
#  endif
#  define SPI_BOOST_HAS_PARTIAL_STD_ALLOCATOR
#  if defined(SPI_BOOST_MSVC) && (SPI_BOOST_MSVC < 1300)
...
// and no <slist> at all
#else
#  define SPI_BOOST_MSVC_STD_ITERATOR 1
...
#     ifndef __MTA__ 
#        define SPI_BOOST_NO_STD_MIN_MAX
#     endif
#     define SPI_BOOST_NO_MS_INT64_NUMERIC_LIMITS
#  endif
#endif
...
#  define SPI_BOOST_STD_EXTENSION_NAMESPACE stdext
#endif
...
#if !_HAS_EXCEPTIONS && ((defined(SPI_BOOST_MSVC) && SPI_BOOST_MSVC >= 1400) || (defined(__clang__) && defined(_MSC_VER)))
#include <exception>
#endif
#include <typeinfo>
	...
	&& !defined(__VXWORKS__)
#  define SPI_BOOST_NO_STD_TYPEINFO
#endif  
...
#if ((!defined(_HAS_TR1_IMPORTS) || (_HAS_TR1_IMPORTS+0 == 0)) && !defined(SPI_BOOST_NO_CXX11_HDR_TUPLE)) \
...
// C++17 features
#if !defined(_CPPLIB_VER) || (_CPPLIB_VER < 650) || !defined(SPI_BOOST_MSVC) || (SPI_BOOST_MSVC < 1910) || !defined(_HAS_CXX17) || (_HAS_CXX17 == 0)
...
#if !(!defined(_CPPLIB_VER) || (_CPPLIB_VER < 650) || !defined(SPI_BOOST_MSVC) || (SPI_BOOST_MSVC < 1912) || !defined(_HAS_CXX17) || (_HAS_CXX17 == 0))
// Deprecated std::iterator:
#  define SPI_BOOST_NO_STD_ITERATOR
#endif

#if defined(SPI_BOOST_INTEL) && (SPI_BOOST_INTEL <= 1400)
...
#    define SPI_BOOST_NO_CXX98_FUNCTION_BASE
...
#  define SPI_BOOST_NO_CXX11_HDR_MUTEX
#endif
#ifndef SPI_BOOST_NO_CXX11_HDR_ATOMIC
#  define SPI_BOOST_NO_CXX11_HDR_ATOMIC
#endif
#ifndef SPI_BOOST_NO_CXX11_HDR_FUTURE
#  define SPI_BOOST_NO_CXX11_HDR_FUTURE
#endif
...
#  define SPI_BOOST_NO_CXX14_HDR_SHARED_MUTEX
#endif
#ifndef SPI_BOOST_NO_CXX14_STD_EXCHANGE
#  define SPI_BOOST_NO_CXX14_STD_EXCHANGE
#endif
#ifndef SPI_BOOST_NO_FENV_H
#  define SPI_BOOST_NO_FENV_H
#endif
#endif

#ifdef _CPPLIB_VER
#  define SPI_BOOST_DINKUMWARE_STDLIB _CPPLIB_VER
#else
#  define SPI_BOOST_DINKUMWARE_STDLIB 1
#endif

#ifdef _CPPLIB_VER
#  define SPI_BOOST_STDLIB "Dinkumware standard library version " SPI_BOOST_STRINGIZE(_CPPLIB_VER)
#else
#  define SPI_BOOST_STDLIB "Dinkumware standard library version 1.x"
#endif
