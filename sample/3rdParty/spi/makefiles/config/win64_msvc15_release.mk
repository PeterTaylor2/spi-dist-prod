...
G_ABI=Release-x64-vc15
G_BUILD_DIR=win64/msvc15_release
...
# /arch:SSE2 unknown option

G_CFLAGS = $(I_CFLAGS) 
G_CPPFLAGS = $(I_CFLAGS) -EHsc 
...
I_LFLAGS = /profile /incremental:no /nodefaultlib /fixed:no $(G_OPTIMIZE_LFLAGS) $(U_WIN64_RELEASE_LFLAGS)
