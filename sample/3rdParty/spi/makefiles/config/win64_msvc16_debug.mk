# definitions for building 64-bit libraries and applications on Windows
# using the VC16 compiler

G_ABI=Debug-x64-vc16
G_BUILD_DIR=win64/msvc16_debug

include $(U_SPI_HOME)/makefiles/config/win64_msvc16.mk
...
I_DEFINES = -D_CRT_SECURE_NO_WARNINGS $(U_DEFINES) $(U_DEBUG_CFLAGS) $(U_WIN64_DEBUG_CFLAGS)
...
I_LFLAGS = /profile /nodefaultlib /fixed:NO $(G_DEBUG_LFLAGS) $(U_WIN64_DEBUG_LFLAGS)
