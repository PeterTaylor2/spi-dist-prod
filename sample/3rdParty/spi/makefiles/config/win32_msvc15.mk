...
I_VC15_PATH:=$(I_VS15_HOME)/VC/Tools/MSVC/$(G_VS15_TOOLS_VERSION)/bin/Hostx86/x86:$(I_VS15_HOME)/Common7/IDE:$(I_WINDOWS_KITS_BIN)
...
LIB:=$(I_VS15_HOME_DOS)\VC\Tools\MSVC\$(G_VS15_TOOLS_VERSION)\lib\x86;$(I_WINDOWS_KITS_BASE_LIB)\ucrt\x86;$(I_WINDOWS_KITS_BASE_LIB)\um\x86;$(I_WINDOWS_KITS)\NETFXSDK\$(G_VS15_NETFXSDK_VERSION)\Lib\um\x86
