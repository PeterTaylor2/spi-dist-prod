...
###########################################################################
include $(U_SPI_HOME)/makefiles/config/win32.mk

I_VS16_HOME:=$(G_WIN32_PROGRAM_FILES)/Microsoft Visual Studio/2019/$(G_VS16_PACKAGE_TYPE)
I_VS16_HOME_DOS:=$(I_WIN32_PROGRAM_FILES_DOS)\Microsoft Visual Studio\2019\$(G_VS16_PACKAGE_TYPE)

I_WINDOWS_KITS=$(I_WIN32_PROGRAM_FILES_DOS)\Windows Kits
I_WINDOWS_KITS_BASE_INCLUDE=$(I_WINDOWS_KITS)\10\include\$(G_VS16_KITS_VERSION)
I_WINDOWS_KITS_BASE_LIB=$(I_WINDOWS_KITS)\10\lib\$(G_VS16_KITS_VERSION)
I_WINDOWS_KITS_BIN=$(G_WIN32_PROGRAM_FILES)/Windows Kits/10/bin/$(G_VS16_KITS_VERSION)/x86

I_VS16_PATH:=$(I_VS16_HOME)/VC/Tools/MSVC/$(G_VS16_TOOLS_VERSION)/bin/Hostx86/x86:$(I_VS16_HOME)/Common7/IDE:$(I_WINDOWS_KITS_BIN)

PATH:=$(I_VS16_PATH):$(PATH)
INCLUDE:=$(I_VS16_HOME_DOS)\VC\Tools\MSVC\$(G_VS16_TOOLS_VERSION)\include;$(I_WINDOWS_KITS_BASE_INCLUDE)\ucrt;$(I_WINDOWS_KITS_BASE_INCLUDE)\um;$(I_WINDOWS_KITS_BASE_INCLUDE)\shared
LIB:=$(I_VS16_HOME_DOS)\VC\Tools\MSVC\$(G_VS16_TOOLS_VERSION)\lib\x86;$(I_WINDOWS_KITS_BASE_LIB)\ucrt\x86;$(I_WINDOWS_KITS_BASE_LIB)\um\x86;$(I_WINDOWS_KITS)\NETFXSDK\$(G_VS16_NETFXSDK_VERSION)\Lib\um\x86
