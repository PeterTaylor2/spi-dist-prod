...
# on Windows using the VC16 compiler
#
...
I_WINDOWS_KITS_BIN=$(G_WIN32_PROGRAM_FILES)/Windows Kits/10/bin/$(G_VS16_KITS_VERSION)/x64

I_VS16_PATH:=$(I_VS16_HOME)/VC/Tools/MSVC/$(G_VS16_TOOLS_VERSION)/bin/Hostx86/x64:$(I_VS16_HOME)/Common7/IDE:$(I_WINDOWS_KITS_BIN)
...
LIB:=$(I_VS16_HOME_DOS)\VC\Tools\MSVC\$(G_VS16_TOOLS_VERSION)\lib\x64;$(I_WINDOWS_KITS_BASE_LIB)\ucrt\x64;$(I_WINDOWS_KITS_BASE_LIB)\um\x64;$(I_WINDOWS_KITS)\NETFXSDK\$(G_VS16_NETFXSDK_VERSION)\Lib\um\x64
