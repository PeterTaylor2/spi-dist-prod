...
def makeProj14(fileName, name, target, srcDir, configPatterns, servicePatterns,
...
if __name__ == "__main__":
    ...
    makeProj14(fileName, name, target, srcDir, configPatterns, servicePatterns,
               includePath, compiler,
               **kwargs)
    pass #end-def
