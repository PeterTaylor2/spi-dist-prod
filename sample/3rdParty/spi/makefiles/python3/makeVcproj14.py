# makes a visual studio project file for VC14
...
def abiFunc(bits, debug):
    if bits == 64:
        return "x64\\%s-vc14" % debug
    return "x86\\%s-vc14" % debug

def makeProj14(fileName, name, compiler, srcDir, incDir, includePath,
...
if __name__ == "__main__":
    ...
    makeProj14(fileName, name, compiler, srcDir, incDir, includePath,
               headerPatterns, sourcePatterns,
